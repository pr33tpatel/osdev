  ...
  namespace drivers {
    ...
    class VideoGraphicsArray {
      ...
      public:
        ...
        virtual void PutPixel(common::uint32_t x, common::uint32_t y, common::uint8_t r, common::uint8_t g, common::uint8_t b); // (x,y) coordinate with RGB value
        virtual void PutPixel(common::uint32_t x, common::uint32_t y, common::uint8_t colorIndex); 
    };
  }
}
