...
class Desktop : public CompositeWidget, public os::drivers::MouseEventHandler {
 protected:
  ...
  // FIXME: this could be a horrible design, why is the MouseSensitivity a part of the Desktop and not the mouse, i dont
  // know ?
 ...
 public:
  Desktop(
      os::common::int32_t w,
      os::common::int32_t h,
      os::common::uint32_t r,
      os::common::uint32_t g,
      os::common::uint32_t b
  );
  ~Desktop();
